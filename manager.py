...
' ╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚══╝',
    ...
    print(f'   Version: 1.0 | Author: @wft_ariyan{n}\n')
...
while True:
    ...
    print(lg+'[4] Update your App'+n)
    print(lg+'[5] Display All Accounts'+n)
    print(lg+'[6] Report Scam'+n)
    print(lg+'[7] Adder'+n)
    a = int(input('\nEnter your choice: '))
    if a == 1:
        input("termux-open-url https://t.me/NixaWorld")
        new_accs = []
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 23842900 , 'd21e95895cf2a5b83b0167fdd3b6e541')
                c.start(number)
        ...
        if len(accounts) == 0:
            ...
            for account in accounts:
                phone = str(account[0])
                client = TelegramClient(f'sessions/{phone}', 23842900 , 'd21e95895cf2a5b83b0167fdd3b6e541')
                client.connect()
        ...
        for a in accounts:
            ...
            clnt = TelegramClient(f'sessions/{phn}', 23842900 , 'd21e95895cf2a5b83b0167fdd3b6e541')
            clnt.connect()
            banned = []
        ...
        for acc in to_use:
            stop = index + 60
            c = TelegramClient(f'sessions/{acc[0]}', 23842900 , 'd21e95895cf2a5b83b0167fdd3b6e541')
